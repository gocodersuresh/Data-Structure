...
class Graph {
    ...
    public void traverseNeighbours(int currentVertex, List<Integer> destinationList) {
        for (int i = 0; i < destinationList.size(); i++) {
            ...
            try {
                ...
                out.println(currentDestination);
            } catch (Exception e) {
                out.println("traverse problem" + e.getMessage());
            }
    ...
    public void traverseNeighboursDec(int currentVertex, List<Integer> destinationList) {
        for (int i = 0; i < destinationList.size(); i++) {
            ...
            try {
                currentDestination = destinationList.get(i);
                visitedNodes[currentDestination]=1;
    ...
    public void decreamentIndegree(int currentDestination){
        ...
        try {
            ...
            out.println("root exception" + e.getMessage());
        }
    }
...
public static void main(String[] args){
    ...
    g.toppologicalSort();
out.println(g.toppologicalSort);
    out.println("g.indegree");


    while(g.toppologicalSort.isEmpty())
    System.out.println(g.toppologicalSort.pop());
}
}
